...
//
function GetWindowsVer:string;overload;
function GetWindowsVer(dwMajorVersion,dwMinorVersion,dwBuildNumber:dword):string;overload;
...
function GetWindowsVer(dwMajorVersion,dwMinorVersion,dwBuildNumber:dword):string;
begin
   result:=(inttostr(dwMajorVersion)
             +'.'+inttostr(dwMinorVersion)
             +'.'+inttostr(dwBuildNumber) );
if dwMajorVersion =10 then
   begin
        case dwBuildNumber of
        10240:result:=result+'-1507'; //ok
        10586:result:=result+'-1511';
        14393:result:=result+'-1607';
        15063:result:=result+'-1703'; //ok
